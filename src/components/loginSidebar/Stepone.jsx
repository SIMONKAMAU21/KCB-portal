...
const Stepone = () => {
  ...
  return (
    <Box h="100%" w="100%" display={{base:"flex",md:"flex" }}justifyContent={{base:"none",md:'center'}} bg='#FAFAFA' flexDirection='column' ml={{base:"10px",md:"108"}}>
      <Box mb='10'  >
      ...
      <VStack gap='10px' width='100%' maxWidth='600px' px='4' >
        <Card p={{base:"7px",md:"20px"}} width='100%' _hover={{ bg: "green.50", border: '2px solid', borderColor: '#D3F2C1', borderRadius: "10px" }}
        onClick={login}
        >
          <HStack spacing='4'>
        ...
        <Card p={{base:"7px",md:"20px"}} width='100%' cursor='pointer' _hover={{ bg: "green.50", border: '2px solid', borderColor: 'green.500', borderRadius: "10px" }}
          onClick={nextstep}
        >
          <HStack spacing='4'>
